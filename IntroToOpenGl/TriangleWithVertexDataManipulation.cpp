...
TriangleWithVertexDataManipulation TriangleWithVertexDataManipulation::instance;

TriangleWithVertexDataManipulation::TriangleWithVertexDataManipulation()
{
	VAO = 0;
	VBO = 0;
	shaderProgram = 0;
...
void TriangleWithVertexDataManipulation::Start()
{
...
// Vertex shader
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0); // || DEFINE ||
...
void TriangleWithVertexDataManipulation::Update()
{
}

void TriangleWithVertexDataManipulation::ImGuiRender(GLFWwindow* window)
{
	GLint viewport[4];
...
void TriangleWithVertexDataManipulation::Render()
{
	// == Drawing ==
