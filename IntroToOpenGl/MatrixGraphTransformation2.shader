...
void main()
{
	...
	// To create lines horizontal and vertical
	...
	// Lerp between the two so that the center is rendered with a different color and there is no overlap
